    ...
    Terminus::parseNumericEffecterPDR(const std::vector<uint8_t>& pdr)
{
    ...
    switch (parsedPdr->effecter_data_size)
    {
        ...
        case PLDM_EFFECTER_DATA_SIZE_SINT8:
            parsedPdr->max_settable.value_u8 = utils::readLEValue<uint8_t>(ptr);
            parsedPdr->min_settable.value_u8 = utils::readLEValue<uint8_t>(ptr);
            break;
        case PLDM_EFFECTER_DATA_SIZE_UINT16:
        case PLDM_EFFECTER_DATA_SIZE_SINT16:
            parsedPdr->max_settable.value_u16 =
                utils::readLEValue<uint16_t>(ptr);
            parsedPdr->min_settable.value_u16 =
                utils::readLEValue<uint16_t>(ptr);
            break;
        case PLDM_EFFECTER_DATA_SIZE_UINT32:
        case PLDM_EFFECTER_DATA_SIZE_SINT32:
            parsedPdr->max_settable.value_u32 =
                utils::readLEValue<uint32_t>(ptr);
            parsedPdr->min_settable.value_u32 =
                utils::readLEValue<uint32_t>(ptr);
            break;
        case PLDM_EFFECTER_DATA_SIZE_UINT64:
        case PLDM_EFFECTER_DATA_SIZE_SINT64:
            parsedPdr->max_settable.value_u64 =
                utils::readLEValue<uint64_t>(ptr);
            parsedPdr->min_settable.value_u64 =
                utils::readLEValue<uint64_t>(ptr);
            break;
        default:
            break;
    ...
    switch (parsedPdr->range_field_format)
    {
        ...
        case PLDM_RANGE_FIELD_FORMAT_SINT8:
            parsedPdr->nominal_value.value_u8 =
                utils::readLEValue<uint8_t>(ptr);
            parsedPdr->normal_max.value_u8 = utils::readLEValue<uint8_t>(ptr);
            parsedPdr->normal_min.value_u8 = utils::readLEValue<uint8_t>(ptr);
            parsedPdr->rated_max.value_u8 = utils::readLEValue<uint8_t>(ptr);
            parsedPdr->rated_min.value_u8 = utils::readLEValue<uint8_t>(ptr);
            break;
        case PLDM_RANGE_FIELD_FORMAT_UINT16:
        case PLDM_RANGE_FIELD_FORMAT_SINT16:
            parsedPdr->nominal_value.value_u16 =
                utils::readLEValue<uint16_t>(ptr);
            parsedPdr->normal_max.value_u16 = utils::readLEValue<uint16_t>(ptr);
            parsedPdr->normal_min.value_u16 = utils::readLEValue<uint16_t>(ptr);
            parsedPdr->rated_max.value_u16 = utils::readLEValue<uint16_t>(ptr);
            parsedPdr->rated_min.value_u16 = utils::readLEValue<uint16_t>(ptr);
            break;
        ...
        case PLDM_RANGE_FIELD_FORMAT_REAL32:
            parsedPdr->nominal_value.value_u32 =
                utils::readLEValue<uint32_t>(ptr);
            parsedPdr->normal_max.value_u32 = utils::readLEValue<uint32_t>(ptr);
            parsedPdr->normal_min.value_u32 = utils::readLEValue<uint32_t>(ptr);
            parsedPdr->rated_max.value_u32 = utils::readLEValue<uint32_t>(ptr);
            parsedPdr->rated_min.value_u32 = utils::readLEValue<uint32_t>(ptr);
            break;
        case PLDM_RANGE_FIELD_FORMAT_UINT64:
        case PLDM_RANGE_FIELD_FORMAT_SINT64:
            parsedPdr->nominal_value.value_u64 =
                utils::readLEValue<uint64_t>(ptr);
            parsedPdr->normal_max.value_u64 = utils::readLEValue<uint64_t>(ptr);
            parsedPdr->normal_min.value_u64 = utils::readLEValue<uint64_t>(ptr);
            parsedPdr->rated_max.value_u64 = utils::readLEValue<uint64_t>(ptr);
            parsedPdr->rated_min.value_u64 = utils::readLEValue<uint64_t>(ptr);
            break;
        default:
            break;
    }
