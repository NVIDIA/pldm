...
void ItemUpdateManager::updateDeviceCompletion(
    mctp_eid_t /*eid*/, bool status, std::vector<std::string> /*compNames*/)
{
...
software::Activation::Activations ItemUpdateManager::activatePackage()
{
