...
class UpdateManagerIntegrityCheckTest : public testing::Test
{
  protected:
    UpdateManagerIntegrityCheckTest() :
...
TEST_F(UpdateManagerIntegrityCheckTest, processPackage_integrity_check_pass)
{
