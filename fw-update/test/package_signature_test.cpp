  ...
  protected:
    PackageSignatureTest(){
        ...
        signedPackageV3WithPublicKey = {
            ...
            0x03,0x00,  //minor version equals 1 means that to the signature header is added 
                        //publicKey
            //Security Version
            0x00,
            ...
            //The offset to the Public Key from the start of the signature structure 
            ...
            ,
            ...
            0x00,0x68,
            //Signature
            0x30,0x66,0x02,0x31,0x00,0xb2,0x4c,0x86,0x0b,0x50,0x2d,0x82,0x75,0x2f,0x30,0x45,
            0x38,0x06,0x06,0xde,0xf1,0x86,0xbb,0x2c,0x28,0xff,0x36,0xe8,0xb8,0x86,0x4d,0xf7,
            0x15,0x12,0xb7,0x9b,0x4d,0xe1,0x1d,0x19,0xc3,0x27,0x08,0x46,0xc1,0xfa,0x98,0x28,
            0x81,0x74,0xb8,0xe1,0x92,0x02,0x31,0x00,0xa6,0xdb,0x1b,0x7b,0x63,0xd7,0x7a,0x71,
            0xb2,0x9d,0xdb,0x81,0x47,0x62,0x6f,0xc7,0x1e,0xa2,0xf4,0x56,0x97,0xbe,0x3d,0x71,
            0x16,0xde,0xb1,0xde,0x28,0xb8,0x1b,0xdf,0x12,0x55,0xe7,0x4e,0xa3,0x29,0x77,0x54,
            0x70,0xb8,0x48,0x6e,0xa2,0xfe,0xeb,0x6c,
        ...
        signedPackageV3BrokenSignature = {
            ...
            0x00,0x68,
            //Signature
            0x30,0x66,0x02,0x31,0x00,0xb2,0x4c,0x86,0x0b,0x50,0x2d,0x82,0x75,0x2f,0x30,0x46, // 0x45 -> 0x46
            0x38,0x06,0x06,0xde,0xf1,0x86,0xbb,0x2c,0x28,0xff,0x36,0xe8,0xb8,0x86,0x4d,0xf7,
            0x15,0x12,0xb7,0x9b,0x4d,0xe1,0x1d,0x19,0xc3,0x27,0x08,0x46,0xc1,0xfa,0x98,0x28,
            0x81,0x74,0xb8,0xe1,0x92,0x02,0x31,0x00,0xa6,0xdb,0x1b,0x7b,0x63,0xd7,0x7a,0x71,
            0xb2,0x9d,0xdb,0x81,0x47,0x62,0x6f,0xc7,0x1e,0xa2,0xf4,0x56,0x97,0xbe,0x3d,0x71,
        ...
        signHeaderV3WithoutPaddingCorruptedMajorVersion = {
            ...
            0x5F,0x32,0xCB,0x08,
            //version (Major Version UINT8, Minor Version UINT8)
            0x99,0x00,  //minor version equals 1 means that to the signature header is added 
                        //publicKey
            //Security Version
            0x00,
            //Offset to Signature - The offset to the Signature Size field from the start of 
        ...
        signHeaderV3WithoutPaddingCorruptedSignatureType = {
            ...
            //Signature Type
            0x99, //: ECDSA secp384r1 signature. 0x01 ~ 0xFF: Reserved for future.
...
{
    std::string strPkg((char*)signedPackageV3WithPublicKey.data(), signedPackageV3WithPublicKey.size());
    std::istringstream package(strPkg);
    ...
    bool verificationResult = packageSignatureParser->verify(package, publicKeyCorrupted, sizeOfSignedData);
...
{
    std::string strPkg((char*)signedPackageV3BrokenSignature.data(), signedPackageV3BrokenSignature.size());
    std::istringstream package(strPkg);
    ...
    bool verificationResult = packageSignatureParser->verify(package, publicKey, sizeOfSignedData);
...
{  
    std::unique_ptr<PackageSignature> packageSignatureParser 
        = std::make_unique<PackageSignatureV3>(signHeaderV3WithoutPaddingCorruptedMagic);
...
{  
    std::unique_ptr<PackageSignature> packageSignatureParser 
        = std::make_unique<PackageSignatureV3>(signHeaderV3WithoutPaddingCorruptedMajorVersion);
...
{  
    std::unique_ptr<PackageSignature> packageSignatureParser 
        = std::make_unique<PackageSignatureV3>(signHeaderV3WithoutPaddingCorruptedSignatureType);
...
TEST_F(PackageSignatureTest, signatureV3IntegrityCheck)
{
    ...
    PackageSignatureV3 *ptrPackageSignatureParser = dynamic_cast<PackageSignatureV3*>(packageSignatureParserBase.get());
    ...
    bool integrityCheckResult = packageSignatureParser->integrityCheck(package, sizeOfSignedData);
...
{
    std::string strPkg((char*)signedPackageV3WithCorruptedBytes.data(), signedPackageV3WithCorruptedBytes.size());
    std::istringstream package(strPkg);
...
{
    std::vector<uint8_t> signedPackageV3IncorrectSize(signedPackageV3WithPublicKey);
...
TEST_F(PackageSignatureTest, signatureV3WithUseChunksDisabled)
{
    ...
    PackageSignatureV3TestUseChunks packageSignatureParser(pkgSignHdrData, false);
...
TEST_F(PackageSignatureTest, signatureV3WithUseChunksEnabled)
{
    ...
    PackageSignatureV3TestUseChunks packageSignatureParser(pkgSignHdrData, true);
